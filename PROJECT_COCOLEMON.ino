...
String checkcolor(int redcolor, int greencolor, int bluecolor, int tlux, int rtemp, int rawc){
   ...
   if(redcolor>= 5 && redcolor<=7 && greencolor>=9 && greencolor<=13 && bluecolor>= 7 && bluecolor<= 11 && tlux>=6 && tlux<=10 && rtemp>=5836 && rtemp<=7487){
         Result = "GC";
         
   }else if(redcolor>= 7 && redcolor<=8 && greencolor>=10 && greencolor<=13 && bluecolor>= 7 && bluecolor<= 9 && tlux>=8 && tlux<=12 && rtemp>=5201 && rtemp<=5745){
         Result = "YGC";
         
   }else if(redcolor>= 14 && redcolor<=17 && greencolor>=15 && greencolor<=19 && bluecolor>= 11 && bluecolor<= 13 && tlux>=11 && tlux<=15 && rtemp>=4010 && rtemp<=4693){
         Result = "YC";
